...
import sty from "./PlasmicTooltip.module.css"; // plasmic-import: MVExvJy2PGWP/css
...
function PlasmicTooltip__RenderFunc(props: {
  ...
  return (
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <div
                    className={classNames("all", "__wab_text", sty.text__a2H71)}
                  >
                    {"Hello from Tooltip! "}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__jBuxF)}
                  >
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", "__wab_text", sty.text__bs4)}>
            {"Hover me!"}
          </div>
        ),
        value: args.trigger,
