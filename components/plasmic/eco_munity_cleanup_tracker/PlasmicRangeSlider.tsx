...
import SliderThumb from "../../SliderThumb"; // plasmic-import: pSy1e8vN7OiX/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: obx3B0tFNUQS/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__lyDYx)}>
        {$props.showLabel ? (
          <Label
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames("all", "__wab_text", sty.text__x7FwV)}
                >
                  {"Label"}
                </div>
              ),
      ...
      <div className={classNames("all", sty.freeBox__s2MjF)}>
        <div
