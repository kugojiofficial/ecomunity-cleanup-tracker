...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: trCGZDNBAGU1/css

export type PlasmicTextInput__VariantMembers = {
  type: "soft" | "plain" | "custom";
  flat: "top" | "right" | "bottom" | "left";
  padded: "left" | "right";
};
export type PlasmicTextInput__VariantsArgs = {
  type?: SingleChoiceArg<"soft" | "plain" | "custom">;
    ...
    const child$Props = {
      ...
      className: classNames(
        ...
        sty.ariaInput,
        {
          ...
          [sty.ariaInputtype_custom]: hasVariant($state, "type", "custom"),
