...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: -KsJuL0jv9mr/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 2Y9Fu054Z73j/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: QKLzPubdEqAL/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames("all", sty.svg___5KSz0)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames("all", sty.svg__gcEku)}
            role={"img"}
          />
        ) : null}
      </div>
