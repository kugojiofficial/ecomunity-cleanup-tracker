...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: AutsBCadW5Fv/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: l-gFZfJ16Wap/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox__kJwW)}>
                  <div
                    className={classNames("all", "__wab_text", sty.text__nm6Rt)}
                  >
                    {"This is a Popover!"}
                  </div>
                  <div
                  ...
                  <div
                    className={classNames("all", "__wab_text", sty.text__cnQf0)}
                  >
                    {
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2__yjr0L)}
            label={"Open Popover"}
          />
        ),
