...
import Radio from "../../Radio"; // plasmic-import: 1YrEptTN9BQW/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 0ibcYKvDJapw/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__hKOnI)}>
            <Radio
              className={classNames("__wab_instance", sty.radio___8Wp62)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__iOcNn)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__q0OZ9)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
