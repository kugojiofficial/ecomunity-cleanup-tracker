...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 1YrEptTN9BQW/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames("all", sty.freeBox__vLmSc)}>
        <div className={classNames("all", sty.freeBox__s7PtS)} />
      </div>
      {renderPlasmicSlot({
