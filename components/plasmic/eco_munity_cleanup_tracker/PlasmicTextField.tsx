...
import Label from "../../Label"; // plasmic-import: B86nTnNKdFXp/component
import TextInput from "../../TextInput"; // plasmic-import: trCGZDNBAGU1/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: iGQioDyAhh3I/component
import Description from "../../Description"; // plasmic-import: H6gs7zL914fN/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: nhNi86WWHkJQ/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__mf5Xa, {
          [sty.freeBoxiconEnd__mf5XaV7Fh0]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__mf5XaCfbpd]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__mf5Xaxjpqm]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__kHck1, {
            [sty.freeBoxiconStart__kHck1Cfbpd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__kHck1Xjpqm]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__rN6L)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox__dEQs, {
            [sty.freeBoxiconEnd__dEQsV7Fh0]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__dEQsCfbpd]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__huKOa)}
                role={"img"}
              />
            ),
