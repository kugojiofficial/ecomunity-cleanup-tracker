...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: -PDYsBUwNZcp/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__pvKwq)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames("all", sty.freeBox__n05Dq)}>
            <div className={classNames("all", "__wab_text", sty.text__njSmu)}>
              <React.Fragment>
                {(() => {
                  try {
                    return $props.label;
        ...
        {(() => {
          ...
          <BaseText2
            ...
            slot={"description"}
          >
            <div className={classNames("all", "__wab_text", sty.text__lwEI)}>
