...
import Button2 from "../../Button2"; // plasmic-import: of74AgsESh9w/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: m8B3g5V5wboP/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_Ki8o1aaD7u-v"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames("all", sty.freeBox___2VEi)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox___5S9Y1)}>
                      <div
                        className={classNames(
                          "all",
                          "__wab_text",
              ...
              <div className={classNames("all", sty.freeBox__vIugF)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__ctvLn)}>
                      <Button2
                        color={"muted"}
                        label={"Close"}
                        onClick={async event => {
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button2
                  className={classNames("__wab_instance", sty.button2__tuA)}
                  label={
                    <div
                      className={classNames(
                        "all",
