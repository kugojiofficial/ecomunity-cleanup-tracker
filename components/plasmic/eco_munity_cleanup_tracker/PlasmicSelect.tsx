...
import MenuPopover from "../../MenuPopover"; // plasmic-import: Kt_aF930oEu6/component
import MenuItem from "../../MenuItem"; // plasmic-import: -PDYsBUwNZcp/component
import MenuSection from "../../MenuSection"; // plasmic-import: r0QLwtyeGkSF/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: LVXNSsX6u6_R/css

import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: TGpbd19w9eBC/icon
          ...
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames(
                  "__wab_instance",
                  sty.menuSection___2EwV7
                )}
                header={
                  <div
                    className={classNames("all", "__wab_text", sty.text__fOzyH)}
                  >
                    {"Section"}
                  </div>
                }
