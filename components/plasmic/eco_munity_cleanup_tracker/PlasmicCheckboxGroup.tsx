...
import Checkbox from "../../Checkbox"; // plasmic-import: -KsJuL0jv9mr/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: N_TrQdqDrg-u/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__gdm4I)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__expxR)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ldyeh)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___9Y0Y4)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
